# app/supervisor.py
from modules import metadata_query, popularity_query, comparison_query, kb_query, complex_query_agent, response_formatter
...
def handle_query(query: str) -> dict:
    if is_metadata_query(query):
        ...
        result = complex_query_agent.run(query, model="sonnet")
        node = "complex_llm2"
    else:
        result = call_bedrock_llm1(query)
        node = "fallback_llm1"
