...
# Content
from src.sql.tools.common.admin_tools import ALL_SQL_TOOLS
...
ALL_COMMON_TOOLS = [ALL_SQL_TOOLS + ALL_VALIDATION_TOOLS]
...
ALL_SQL_TOOLS = ALL_BUSINESS_TOOLS + ALL_COMMON_TOOLS + ALL_CONTENT_TOOLS + ALL_PLATFORM_TOOLS + ALL_TALENT_TOOLS 