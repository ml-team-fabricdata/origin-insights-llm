...
COMMON_PROJECTS_BY_IDS_TOOL = Tool.from_function(
    ...
    description=(
        ...
        "Parameters: actor_director (string with format 'ActorName_DirectorName', e.g., 'Leonardo DiCaprio_Martin Scorsese') OR separate actor_name and director_name parameters. "
