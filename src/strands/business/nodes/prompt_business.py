...
2. get_top_by_uid(uid)
   - Use for: "rating for [title]", "position of [title]", "top for UID"
   - uid: Content unique identifier
   - Example: "Rating for ts123456" → get_top_by_uid("ts123456")
...
Workflow:
1. Identify question type (genre momentum/top rankings/specific UID)
2. Extract parameters (country, platform, genre, etc.)
3. Call appropriate tool with extracted parameters
4. Return tool's response directly
