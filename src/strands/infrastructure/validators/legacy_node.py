...
Please update your imports:
  from src.strands.infrastructure.validators.legacy_node import resolve_country_iso
  →
  from src.strands.infrastructure.validators.legacy import resolve_country_iso
