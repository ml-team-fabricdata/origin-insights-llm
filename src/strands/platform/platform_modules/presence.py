...
from src.strands.platform.platform_queries.queries_presence import *
...
def build_where_clause(filters: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
    ...
    # Country already validated by validation_node
    if filters.get("country"):
        conditions.append("p.iso_alpha2 = %(country_iso)s")
        params["country_iso"] = filters["country"]

    # Platform name already validated by validation_node
    ...
    # Content type already validated by validation_node
    if filters.get("type"):
