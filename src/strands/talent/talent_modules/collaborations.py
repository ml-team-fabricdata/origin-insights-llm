from src.strands.talent.talent_queries.queries_collaborations import *
...
def get_common_projects_actor_director_by_name(
        ...
        if '_' in actor_director:
            ...
            if len(parts) == 2 and parts[0].isdigit() and parts[1].isdigit():
                ...
                limit = validate_limit(
                    limit, default=DEFAULT_LIMIT, max_limit=100)
    ...
    result = find_common_titles_actor_director(
        actor_name, director_name, limit)
